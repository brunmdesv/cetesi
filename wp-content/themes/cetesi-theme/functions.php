 ...
 * (Função movida para o final do arquivo para compatibilidade com mobile header)
 */
...
function cetesi_fallback_menu() {
    ...
    echo '<li><a href="' . esc_url( home_url( '/' ) ) . '" class="mobile-menu-link">Início</a></li>';
    echo '<li><a href="' . esc_url( home_url( '/cursos' ) ) . '" class="mobile-menu-link">Cursos</a></li>';
    echo '<li><a href="' . esc_url( home_url( '/sobre' ) ) . '" class="mobile-menu-link">Sobre</a></li>';
    echo '<li><a href="' . esc_url( home_url( '/contato' ) ) . '" class="mobile-menu-link">Contato</a></li>';
    echo '</ul>';
}
